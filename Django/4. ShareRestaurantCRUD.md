...
<body>
    <div class="container">
        ...
        <div class="content">
            <form action="./create" method="POST" onsubmit="return checkFrom();">
                <div class="inputDiv">
                    <div class="input-group">
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="row">
                <form action="" method="POST" onsubmit="return emailCheckForm
...
<body>
    <div class="container">
        ...
        <div class="content">
            <form action="./update" method="POST" onsubmit="return checkFrom();"> 
                <div class="inputDiv">
                    <div class="input-group">
                        <span class="input-group-addon" id="sizing-addon2">카테고리</span>
                        <select id="resCategory" name="resCategory" class="resCategory" size="1" required autofocus>
